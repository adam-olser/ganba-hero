 ...
 * Icon Component
 * 
 * SVG icons for the app using react-native-svg.
 */
...
export function Icon({ name, size = 24, color = colors.textPrimary }: IconProps) {
  const icons: Record<IconName, React.ReactNode> = {
    ...
    flame: (
      <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
        <Path
          d="M12 22C16.4183 22 20 18.4183 20 14C20 10 17 7 15 5C15 8 13 10 12 10C11 10 9 8 9 5C7 7 4 10 4 14C4 18.4183 7.58172 22 12 22Z"
          stroke={color}
          strokeWidth={2}
          strokeLinecap="round"
          strokeLinejoin="round"
